...
#Crystal information
L=600*10**(-6)   # sample thickness
w0=35*10**(-6)    # beam waist at focus
E=np.array([20.3,12,52.8])*10**(-6)    # incident energies
E_err=np.array([0.912,0.74,2.52])*10**(-6)
dt=300*10**(-15)    #   pulse width (here 30 fs)
...
pos_index_at_absorption_beginning = find_index(position,-1.75)
