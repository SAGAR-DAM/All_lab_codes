...
#
pump_image_p = io.imread("D:\\Data Lab\\Polarimetry\\dec 2023\\27th dec\\27th dec 2023 P D\\pump only\\P_002.tif")
...
pump_image_c = io.imread("D:\\Data Lab\\Polarimetry\\dec 2023\\27th dec\\27th dec 2023 T Q\\pump only\\C_002.tif")


pump_image_c_tl, pump_image_c_br = mm.get_image_tl_and_br(image=pump_image_c, background_factor=1.05)
...
def make_s_normalized(image_P, image_C):
    try:
        background_factor = bisection(f = get_mod_s, a=1, b=1.2, image_P=image_P, image_C=image_C, tol=0.05)
    except:
        a, b = find_interval_with_sign_change(f = get_mod_s, lower = 1, upper = 2, image_P= image_P, image_C=image_C)
        background_factor = bisection(f = get_mod_s, a=a, b=b, image_P=image_P, image_C=image_C, tol=0.05)
    return(background_factor)
    



files_p = glob.glob("D:\\Data Lab\\Polarimetry\\dec 2023\\27th dec\\27th dec 2023 P D\\pump probe\\*.tif")
files_c = glob.glob("D:\\Data Lab\\Polarimetry\\dec 2023\\27th dec\\27th dec 2023 T Q\\pump probe\\*.tif")
