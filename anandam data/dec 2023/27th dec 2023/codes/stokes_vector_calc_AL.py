...
#
pump_image_p = io.imread("D:\\data Lab\\anandam data\\dec 2023\\27th dec 2023\\good data\\Aluminium\\P D\\pump only\\P_002.tif")
...
pump_image_c = io.imread("D:\\data Lab\\anandam data\\dec 2023\\27th dec 2023\\good data\\Aluminium\\T Q\\pump only\\C_002.tif")
...
files_p = sorted(glob.glob("D:\\data Lab\\anandam data\\dec 2023\\27th dec 2023\\good data\\Aluminium\\P D\\pump probe\\*.tif"))
files_c = sorted(glob.glob("D:\\data Lab\\anandam data\\dec 2023\\27th dec 2023\\good data\\Aluminium\\T Q\\pump probe\\*.tif"))
...
for i in range(len(fileset)):
    ...
    df.to_csv(f'D:\\data Lab\\anandam data\dec 2023\\27th dec 2023\\good data\\Aluminium\\csv files\\{retro[i]}.csv', index=False)
