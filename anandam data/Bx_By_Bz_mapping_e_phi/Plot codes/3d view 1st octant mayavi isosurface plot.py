# -*- coding: utf-8 -*-
"""
Created on Thu May  1 11:54:21 2025
...
x, y, z = np.meshgrid(x, y, z, indexing='ij')  # Match shape with potentiaellipticity



mlab.figure(bgcolor=(1, 1, 1), size=(800, 600))
mlab.contour3d(x, y, z, ellipticity, contours=200, opacity=0.3, colormap='jet')
axes = mlab.axes(xlabel='Bx', ylabel='By', zlabel='Bz',color=(1.0,0.0,0.0))
