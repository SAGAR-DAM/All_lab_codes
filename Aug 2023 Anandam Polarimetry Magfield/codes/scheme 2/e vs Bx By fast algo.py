...
final_ellip_array=np.concatenate([final_ellip_array,-final_ellip_array,final_ellip_array,-final_ellip_array])

#print(final_ellip_array)

#file_name = "D:\\data Lab\\Aug 2023 Anandam Polarimetry Magfield\\codes\\scheme 2\\Fast algo matrices\\e matrices\\e0007_t_7_0.txt"
...
mlab.mesh(Bx,By,25*final_ellip_array,representation='surface')
mlab.axes(extent=[-100, 100, -100, 100, -70, 70], color=(0, 0, 0), nb_labels=5)
#mlab.show()

plt.imshow(final_ellip_array[0:200])
plt.show()
