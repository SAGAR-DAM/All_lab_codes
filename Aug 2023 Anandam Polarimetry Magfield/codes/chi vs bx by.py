...
Bx,By=np.mgrid[0:50:101j,0:50:101j]
final_chi_array=5*final_stokes(Bx*10**6,By*10**6)

print(final_chi_array)


mlab.mesh(Bx,By,final_chi_array,representation='surface')
mlab.axes(extent=[0, 100, 0, 100, 0, 100], color=(0, 0, 0), nb_labels=5)
#mlab.show()
