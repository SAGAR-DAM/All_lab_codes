...
files=glob.glob("D:\\data Lab\\Single shot SD\\11_oct_2023_SD_Frog\\scan 2\\*.txt")
...
for i in range(len(set_numbers)):
    ...
    for j in range(set_numbers[i]):
        ...
        plt.savefig("D:\\data Lab\\Single shot SD\\11_oct_2023_SD_Frog\\scan 2\\plots\\%s.png"%filename,bbox_inches='tight')
        plt.show()
...
plt.savefig("D:\\data Lab\\Single shot SD\\11_oct_2023_SD_Frog\\scan 2\\plots\\spectrum variation.png",bbox_inches='tight')
plt.show()
...
plt.savefig("D:\\data Lab\\Single shot SD\\11_oct_2023_SD_Frog\\scan 2\\plots\\bandweidth variation.png",bbox_inches='tight')
plt.show()
