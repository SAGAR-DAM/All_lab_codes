...
ax.fill_between(time_delays, velocity_lower_lim, velocity_upper_lim, color="k", alpha=0.2)

# Grid settings
# ax.grid(lw=0.3, color='k')

# Labels and title
ax.set_xlabel("delay (ps)", fontweight='bold')
...
ab = AnnotationBbox(imbox, (-7.0, 1.27e7),frameon=False, zorder=10)  # High z-order ensures it's in front
ax.add_artist(ab)
