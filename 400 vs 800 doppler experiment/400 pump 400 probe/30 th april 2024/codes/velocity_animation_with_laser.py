...
# ani.save("D:\\data Lab\\400 vs 800 doppler experiment\\400 pump 400 probe\\30 th april 2024\\codes\\velocity_animation_I_6_18_with_laser.gif", writer='pillow', fps=3)
# Show the plot
plt.show()
