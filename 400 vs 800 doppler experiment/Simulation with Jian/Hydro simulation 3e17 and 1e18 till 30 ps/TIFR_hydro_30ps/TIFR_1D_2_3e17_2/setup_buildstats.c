...
void FTOC(setup_buildstats)(char* build_date, 
     ...
     strncpy(build_date, "Thu 10 Apr 2025 10:04:28 AM EEST",80);
     strncpy(build_dir, "/media/ong/WORKDIR1/TIFR_1D_2_3e17_2", 80);
     strncpy(build_machine, "Linux ong-ThinkStation-P720 6.11.0-21-generic #21~24.04.1-Ubuntu SMP PREEMPT_DYN", 80);
     strncpy(setup_call, "/home/ong/FLASH4.8/bin/setup.py -auto -objdir=/media/ong/WORKDIR1/TIFR_1D_2_3e17_2 LaserTIFR -1d +cartesian -nxb=32 +pm4dev +hdf5typeio species=cham,targ +mtmmmt +uhd3t +laser ed_maxPulseSections=64 +mgd mgd_meshgroups=6 -parfile=tifr_1D_2.par ",400);
