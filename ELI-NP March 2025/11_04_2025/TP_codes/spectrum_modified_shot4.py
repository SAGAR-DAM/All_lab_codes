...
cutoff_index_integrated_count = find_index(integrated_count,np.max(integrated_count)*0.99998)
...
np.savetxt(fr"{parent_dir}\separated_TP_images\{txtfilename}", data, fmt='%.5f', header='Energy(MeV) Flux(/MeV/Srad)', comments='')
