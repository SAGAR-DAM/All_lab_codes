...
# %%
imagepath = r"D:\data Lab\ELI-NP March 2025\09_04_2025\separated TP images\09042025_All_TP_19_48_SCAN2-[Phosphor]_shot5.tif"
...
image = image[a:b,:]
description = r"Nano wires 1.2$\mu$m sub 100nm diameter gap 300nm height 1$\mu$m"
...
def get_magnetic_trace(image,coeffs,x_range=None, band=5, tolerance=3):
    h, w = image.shape
...
cutoff_index_integrated_count = find_index(integrated_count,np.max(integrated_count)*0.99991)
