...
# %%
imagepath = r"D:\data Lab\ELI-NP March 2025\02_04_2025\separated TP images\02042025_ESM_5_TP_20_15-[Phosphor]_shot1.tif"
...
image = image[a:b,:]
description = r"Nanowires 1.2$\mu$m subtrate 1umwire 100nm dia 300nm gap (2 shots integrated)"
...
cutoff_index_integrated_count = find_index(integrated_count,np.max(integrated_count)*0.99994)
