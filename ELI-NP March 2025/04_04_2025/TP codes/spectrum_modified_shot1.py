...
# %%
imagepath = r"D:\data Lab\ELI-NP March 2025\04_04_2025\separated out images\04042025_TP_20_02_scan_2-[Phosphor]_shot1.tif"
...
image = image[a:b,:]
description = r"Nano wires 1.2$\mu$m sub 100nm diameter gap 300nm height 1um"
...
cutoff_index_integrated_count = find_index(integrated_count,np.max(integrated_count)*0.9998)
...
np.savetxt(fr"{parent_dir}\separated out images\{txtfilename}", data, fmt='%.5f', header='Energy(MeV) Flux(/MeV/Srad)', comments='')
