...
def main():
    files=glob.glob("D:\\data Lab\\Supercontinuum-march 2023\\15th march SCG\\Spectrum Measurement\\data\\*.trt")
    fileset=[5,1,5,6,2,6,5]      #number of files for which the  averaging is carried out
    ...
    for i in range(len(fileset)):
        ...
        plt.savefig("D:\\data Lab\\Supercontinuum-march 2023\\15th march SCG\\Spectrum Measurement\\averaged over plots\\%s.jpg"%(h[2:len(h)-1]),bbox_inches='tight')
        plt.show()
