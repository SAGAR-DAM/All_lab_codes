...
def main():
    files=glob.glob("D:\\data Lab\\Supercontinuum-march 2023\\6th april 2023\\Spectrum Measurement\\data\\*.trt")
    fileset=[5,5,5,5,5]      #number of files for which the  averaging is carried out
    ...
    for i in range(len(fileset)):
        ...
        plt.savefig("D:\\data Lab\\Supercontinuum-march 2023\\6th april 2023\\Spectrum Measurement\\averaged over plots\\%s.jpg"%(h[2:len(h)-1]),bbox_inches='tight')
        plt.show()
    ...
    plt.savefig("D:\\data Lab\\Supercontinuum-march 2023\\6th april 2023\\Spectrum Measurement\\averaged over plots\\%s.jpg"%('Comparisn of different supercontinuums Un-Normalized'),bbox_inches='tight')
    plt.show()
    ...
    for i in range(len(labels)):
        ...
        plt.legend(loc='upper center', bbox_to_anchor=(0.5, -0.15))
    plt.savefig("D:\\data Lab\\Supercontinuum-march 2023\\6th april 2023\\Spectrum Measurement\\averaged over plots\\%s.jpg"%('Comparisn of different supercontinuums Normalized'),bbox_inches='tight')
    plt.show()
